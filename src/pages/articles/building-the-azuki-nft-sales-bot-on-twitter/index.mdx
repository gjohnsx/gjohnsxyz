...
export const meta = {
  ...
  date: '2022-02-21',
  title: 'Building the Azuki NFT Sales Bot on Twitter',
  description:
...
<Image src={officialAnnouncement} alt="@AzukiOfficial Twitter Account announcing my sales bot." />
...
<Image src={exampleSale} alt="Tweet from @AzukiSales bot on August 9, 2022 announcing a sale of an Azuki NFT with the image." />
...
[Visit GitHub](https://github.com/gjohnsx/Azuki-Sales-Bot)

[Visit Twitter](https://twitter.com/azukisales)
