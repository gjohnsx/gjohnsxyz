...
import logoOmicron from '@/images/logos/omicronlogo.png'
import logoPearson from '@/images/logos/pearsonlogosm2.png'
import logoRrm from '@/images/logos/rrmlogo.png'

import beanz15578 from '@/images/photos/beanz15578.png'
import azuki5680 from '@/images/photos/azuki5680.png'
import phunk5188 from '@/images/photos/phunk5188.png'
import theplague2841 from '@/images/photos/theplague2841.png'
import deadavatars from '@/images/photos/deadavatars.png'
...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <Link className="p-1 -m-1 group" target="_blank" rel="noreferrer" {...props}>
...
function Resume() {
  let resume = [
    {
      ...
      title: 'Developer & Growth Marketer',
      logo: avatarImage,
      start: '2017',
      end: {
        label: 'Present',
  ...
  return (
    <div className="p-6 border rounded-2xl border-zinc-100 dark:border-zinc-700/40">
      ...
      <Button href="/resume.pdf" variant="secondary" className="w-full mt-6 group" target="_blank">
        Download CV
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="flex justify-center gap-5 py-4 -my-4 overflow-hidden sm:gap-8">
        {[theplague2841, azuki5680, phunk5188, deadavatars, beanz15578].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Gregory Johns - Fullstack engineer and digital product designer
        </title>
        <meta
          name="description"
          content="I’m Gregory, a fullstack engineer and entrepreneur based in Orlando."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Fullstack engineer, digital marketer, and father.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Gregory, a software designer and entrepreneur with a mission. My goal is to bring cryptographic truth to the forefront of our digital world and create web3 user experiences that will drive mass adoption. Let&apos;s work together to build a better future.
          </p>
